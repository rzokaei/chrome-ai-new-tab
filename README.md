...
A Manifest V3 Chrome extension that lets you chat with OpenAI or Gemini, open favorite websites, view Google Calendar events, manage local events, and read live BBC News headlines directly inside every new tab. It streams AI responses in place and never redirects you unless you choose to open a news article.
...
- The five latest BBC News headlines appear beneath the calendar and refresh every 15 minutes.
...
- `feeds.bbci.co.uk`: retrieves the official BBC News RSS headline feed.
